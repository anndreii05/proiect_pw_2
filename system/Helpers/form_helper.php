...
if (! function_exists('form_submit'))
{
	...
	function form_submit($data = '', string $value = '', $extra = ''): string
	{
		...
		return '<input class="btn btn-primary" ' . parse_form_attributes($data, $defaults) . stringify_attributes($extra) . " />\n";
	}
}
...
if (! function_exists('form_button'))
{
	...
	function form_button($data = '', string $content = '', $extra = ''): string
	{
		...
		return '<button class="btn btn-primary" ' . parse_form_attributes($data, $defaults) . stringify_attributes($extra) . '>'
				. $content
				. "</button>\n";
	}
}
