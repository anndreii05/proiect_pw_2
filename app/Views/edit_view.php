    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="produse" style="margin-top:20px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Editare înregistrare</h2>
                <!-- Icon Divider-->
                ...
                <?php echo form_input($data3);?>
                    <table class="table">
                    <tr>
                    <td><?php echo form_label('Marca ', 'marca');?></td>
                    <td><?php echo form_input($data1);?></td>
                    </tr>
                    <tr>
                    <td><?php echo form_label('Model ', 'model');?></td>
                    <td><?php echo form_input($data1_1);?></td>
                    </tr>
                    <tr>
                    <td><?php echo form_label('Pret ', 'pret');?></td>
                    <td><?php echo form_input($data1_2);?></td>
                    </tr>
                    <tr>
                    ...
                    <h2><img src="<?php echo base_url($image['imagine']);?>" width="100" height="100"></h2>
