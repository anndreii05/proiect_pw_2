    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="produse" style="margin-top:20px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Produse</h2>
                <!-- Icon Divider-->
                ...
                <div class="row justify-content-center">
                    <!-- Portfolio Item 1-->
                    <?php foreach($telefoane as $var) { ?>
                    <div class="col-md-6 col-lg-4 mb-5">
                        <div class="mx-auto">
                            <img class="img-fluid" src="<?php echo base_url($var['imagine']);?>" alt="..." />
                            <center>
                            <h4><?php echo $var['marca'].' '.$var['model']; ?></h4>
                            <i><h6>Preț: <?php echo $var['pret'].' RON'; ?></h6></i>
                            <br>
                            <?php echo '<a class="btn btn-primary" href="produs/'.$var['id'].'">Detalii</a>';?>
                            </center>
