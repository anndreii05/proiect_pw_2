...
<html lang="en">
    <head>
        ...
        <title>Produs - Euro GSM - Magazin telefoane</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="produse" style="margin-top:20px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Detalii produs</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <h3>Marcă: <?php echo $image['marca']; ?></h3><br>
                        <h3>Model: <?php echo $image['model']; ?></h3><br>
                        <h3>Preț: <?php echo $image['pret']; ?> RON</h3><br>
                    </div>
                </div>
                <center>
                ...
                <br><br><!-- comment -->
                <a href="<?php echo site_url('/produse') ?>"><button class="btn btn-primary">Du-mă înapoi</button></a>
                </center>
            </div>
        </section>
