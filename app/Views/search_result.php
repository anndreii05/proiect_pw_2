    ...
    <body id="page-top">
        ...
        <section class="page-section portfolio" id="produse" style="margin-top:20px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">Rezultate</h2>
                <!-- Icon Divider-->
...
$table->setHeading('Marca', 'Model', 'Pret',);

foreach($r as $key =>$val ){
   $table->addRow($val['marca'],$val['model'],$val['pret']);
}
