...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Euro GSM</a>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <img class="masthead-avatar mb-5 svg-modify" src="<?php echo base_url('assets/img/phone.svg'); ?>" alt="Euro GSM" />
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Bine ați venit la <br> Euro GSM.</h1>
                <!-- Icon Divider-->
  ...
  <ellipse cx="270" cy="70" rx="85" ry="55" fill="url(#grad1)" />
  <text fill="#ffffff" font-size="45" font-family="Verdana" x="205" y="86">Hello!</text>
</svg>
            </div>
        </header>
