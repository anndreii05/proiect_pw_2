...
<html lang="en">
    <head>
        ...
        <title>Euro GSM - Magazin telefoane</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="<?php echo base_url('/public/MainController/contact');?>">Contact</a></li>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" style="margin-top:20px;">
            <div class="container">
                ...
                <h2 class="page-section-heading text-center text-uppercase text-white">Despre</h2>
                <!-- Icon Divider-->
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">Pe piața din România de 15 ani, Euro GSM este un magazin ce se ocupă cu, comercializarea de telefoane de ultimă generație.</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">Încă de acum 15 ani, avem deja peste 50 de clienți mulțumiți, cărora le mulțumim pentru încrederea acordată.</p></div>
                </div>
                <br><br>
                <center>
                <div class="row">
                    <div class="col-md-6">
                        <h4>Cea mai bună ofertă a noastră din toate timpurile:</h4>
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/qTAoXQVLVSE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    <div class="col-md-6">
                        <h4>Unul dintre clienții noștri căruia îi mulțumim pentru încrederea acordată!</h4><!-- comment -->
                        <video width="630" height="315" controls>
